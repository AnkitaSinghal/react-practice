...
class Home extends React.Component {
    ...
    static getDerivedStateFromProps(props, state){
        ...
        console.log('2. get derived state from props', props, state);
    ...
    shouldComponentUpdate(nextProps, nextState) {
        console.log('2.a should component update', nextProps, nextState);
        return true;
    ...
    getSnapshotBeforeUpdate(prevProps, prevState){
        ...
        console.log('3.a get snapshot before update', prevProps, prevState);
        return null;
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        console.log('3.b component did update', prevProps, prevState, snapshot)
    }
